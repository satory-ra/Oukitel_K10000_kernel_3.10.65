...
extern int g_bPsSensorOpen;
extern int g_nPsSensorDate;
static DEFINE_MUTEX(msg2133_sensor_mutex_ext);
#endif//TPD_PROXIMITY
/*=============================================================*/
...
extern char msg_tpgesture_value[] ;
        ...
        if (bIsCorrectFormat) 
        {
            ...
            switch (nWakeupMode)
            {
                case 0x58:
					...
					sprintf(msg_tpgesture_value,"DOUBCLICK");
                ...
                case 0x60:
					...
					sprintf(msg_tpgesture_value,"UP");
...
//                    input_report_key(g_InputDevice, KEY_UP, 0);
                ...
                case 0x61:
					...
					sprintf(msg_tpgesture_value,"DOWN");
...
//                    input_report_key(g_InputDevice, KEY_DOWN, 0);
                ...
                case 0x62:
					...
					sprintf(msg_tpgesture_value,"LEFT");
...
//                    input_report_key(g_InputDevice, KEY_LEFT, 0);
                ...
                case 0x63:
					...
					sprintf(msg_tpgesture_value,"RIGHT");
        ...
        */
        if ((pPacket[1] == 0xFF) && (pPacket[2] == 0xFF) && (pPacket[3] == 0xFF) && (pPacket[4] == 0xFF) && (pPacket[6] == 0xFF))
        {
            ...
            {   /* 0x00 is key up, 0xff is touch screen up */
				...
				{
				   if(pPacket[5] == 0x80) // close Panel
					{
						if((g_bPsSensorOpen == 1)&& (g_nPsSensorDate == 1))
						{
							mutex_lock(&msg2133_sensor_mutex_ext);
							g_nPsSensorDate = 0;
							mutex_unlock(&msg2133_sensor_mutex_ext);
						}
					}
					else// Open Panel
					{
