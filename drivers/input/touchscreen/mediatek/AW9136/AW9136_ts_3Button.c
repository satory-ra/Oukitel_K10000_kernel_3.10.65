...
// IO PIN DEFINE
//////////////////////////////////////
#define AW9136_PDN          GPIO_AW9136_PDN_PIN
#define AW9136_EINT_NUM     CUST_EINT_AW9136_INT_NUM
#define AW9136_EINT_PIN     GPIO_AW9136_INT_PIN
...
static int AW9136_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    TS_DBG("AW9136 chip ID = 0x%4x", reg_value);
...
static DEVICE_ATTR(debug, S_IWUGO | S_IRUGO, AW9136_show_debug, AW9136_store_debug);
