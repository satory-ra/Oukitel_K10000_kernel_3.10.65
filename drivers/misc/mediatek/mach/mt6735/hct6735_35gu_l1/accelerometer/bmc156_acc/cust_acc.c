...
#if defined(CONFIG_T935_PROJ)
	#define BMC156_ACC_I2C_BUS_NUM    2
	#define BMC156_ACC_DIRECTION      6
#elif defined(CONFIG_T925_PROJ)||defined(CONFIG_T99_PROJ)||defined(CONFIG_T93_PROJ)||defined(CONFIG_T985_PROJ)
	#define BMC156_ACC_I2C_BUS_NUM    2
