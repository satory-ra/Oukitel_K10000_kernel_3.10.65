...
#endif
#if defined(CONFIG_T99H_HAIER_PROJ)
#define CHARGING_FULL_CURRENT    175	//mA
#else
...
#define USB_CHARGER_CURRENT					CHARGE_CURRENT_500_00_MA	//500mA
	...
	#if defined(CONFIG_T99H_OUQI_PROJ)
...
#if defined(CONFIG_T99_PROJ)
	#define NPERCENT_TRACKING_TIME	   	40	// 120 second
#else
...
#else
	#define V_0PERCENT_TRACKING							3250
