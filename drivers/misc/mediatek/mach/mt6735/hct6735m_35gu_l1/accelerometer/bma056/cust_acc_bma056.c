...
#elif defined(CONFIG_T93_PROJ)||defined(CONFIG_T933_PROJ)||defined(CONFIG_T935_PROJ)
#define ACC_I2C_BUS_NUM 2
...
#else
#define ACC_I2C_BUS_NUM 2
#define ACC_DIRECTION 3
#endif

/*---------------------------------------------------------------------------*/
static struct acc_hw cust_acc_hw = {
    .i2c_num = ACC_I2C_BUS_NUM,
    .direction = ACC_DIRECTION,//bmm056:3 bmm156:5
...
/*---------------------------------------------------------------------------*/
struct acc_hw* get_cust_acc_bma056_hw(void) 
{
    return &cust_acc_hw;
}
