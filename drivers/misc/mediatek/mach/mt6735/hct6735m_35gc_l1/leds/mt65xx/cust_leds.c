...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	#if defined(CONFIG_T87A_OQ_PROJ)
		{"red",               MT65XX_LED_MODE_NONE, -1,{0}},
		{"green",             MT65XX_LED_MODE_NONE, -1,{0}},
		{"blue",              MT65XX_LED_MODE_NONE, -1,{0}},
	#else
...
//	{"button-backlight",	MT65XX_LED_MODE_GPIO, (long)rgb_set_Button_led_by_gpio,{0}},
	...
	#elif defined(CONFIG_T925W_ZZB_PROJ)
...
#if defined(CONFIG_T93_PROJ)||defined(CONFIG_T985_PROJ)||defined(CONFIG_T825C_YX_PROJ)||defined(CONFIG_T87_PROJ)
	{"button-backlight",	MT65XX_LED_MODE_GPIO, (long)rgb_set_Button_led_by_gpio,{0}},
#elif defined(CONFIG_T925M_DH_PROJ) || defined(CONFIG_T925U_YS_T925) || defined(CONFIG_T925X_YS_T925)||defined(CONFIG_T825_PROJ)
