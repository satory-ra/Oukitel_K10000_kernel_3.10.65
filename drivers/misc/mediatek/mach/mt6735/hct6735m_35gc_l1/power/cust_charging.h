...
/* charger error check */
#if defined(CONFIG_T925J_YX)||defined(CONFIG_T825C_YX_PROJ)
...
/* Tracking TIME */
#if defined(CONFIG_T925U_YS_T925) || defined(CONFIG_T925X_YS_T925)
	#define ONEHUNDRED_PERCENT_TRACKING_TIME	60	// 10 second
	#define NPERCENT_TRACKING_TIME	   		120	// 20 second
