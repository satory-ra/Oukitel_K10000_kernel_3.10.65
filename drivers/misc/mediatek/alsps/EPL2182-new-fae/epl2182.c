...
#if DYN_ENABLE
#if defined(CONFIG_T925F_AZYP_PROJ)
	#define DYN_H_OFFSET 	 	1500
	#define DYN_L_OFFSET		800
#else
	#define DYN_H_OFFSET 	 	2000
	#define DYN_L_OFFSET		1000
#endif
