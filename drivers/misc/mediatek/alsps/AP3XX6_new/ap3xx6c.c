...
extern struct alsps_hw *ap3xx6c_get_cust_alsps_hw(void);
...
/*******************************************/
// sam  2015.07.24
	//ap3xx6_set_PSTtime(client, 0x00);   //sam 2015.07.24
	ap3xx6_set_PSTtime(client, 0x05);

	//ap3xx6_set_PSgain(client, 0x03);   //sam 2015.07.24
	ap3xx6_set_PSgain(client, 0x00);

	ap3xx6_set_PSpulse(client, 0x03);

	ap3xx6_set_meantime(client, 0x00);
...
static int ap3xx6_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	mutex_init(&obj->lock);
	obj->hw = ap3xx6c_get_cust_alsps_hw();
...
static int ap3xx6_local_init(void)
{
	struct alsps_hw *hw = ap3xx6c_get_cust_alsps_hw();
