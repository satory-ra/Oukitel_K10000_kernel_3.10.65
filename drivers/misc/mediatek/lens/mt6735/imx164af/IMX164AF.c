...
#define AF_DRVNAME "IMX164AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19
#define PLATFORM_DRIVER_NAME "lens_actuator_imx164af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_imx164af"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
    ...
    char puSendCmd[2] = {(char)((a_u2Data >> 8) | 0xF4) , (char)(a_u2Data & 0xFF)};
...
inline static int getAFInfo(__user stIMX164AF_MotorInfo * pstMotorInfo)
{
    stIMX164AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stIMX164AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stIMX164AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stIMX164AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stIMX164AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case IMX164AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stIMX164AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case IMX164AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stIMX164AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case IMX164AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case IMX164AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case IMX164AFIOC_T_SETMACROPOS :
...
static int __init IMX164AF_i2C_init(void)
{
...
static void __exit IMX164AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(IMX164AF_i2C_init);
module_exit(IMX164AF_i2C_exit);

MODULE_DESCRIPTION("IMX164AF lens module driver");
