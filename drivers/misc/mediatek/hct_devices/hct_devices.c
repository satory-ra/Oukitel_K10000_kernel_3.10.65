...
static void init_msensor_device(struct hct_msensor_device_dinfo *pdevice, struct sensor_init_info * mmsensor)
{
...
static int hct_alspssensor_info_print(struct seq_file *se_f)
{
    ...
    seq_printf(se_f, "alspssensor USAGE:\t \n");
...
static void init_alspssensor_device(struct hct_alspssensor_device_dinfo *pdevice, struct sensor_init_info * malspssensor)
{
