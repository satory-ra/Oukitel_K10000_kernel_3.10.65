...
#define GF66XX_INPUT_DEV_NAME   "gf318-kpd"
//"gf66xx_input_key"
#define GF66XX_INPUT_MENU_KEY   KEY_MENU
#define GF66XX_INPUT_BACK_KEY   KEY_BACK
#define GF66XX_INPUT_HOME_KEY   KEY_F11
#define GF66XX_FF_KEY           KEY_F10
...
0x3d,0x00,0x48,0x00,0x22,0x00,0x00,0x00,0x03,0x07,0x00,0x00,0x20,0x00,0x20,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
{
    return gf66xx_ioctl(filp, cmd, (unsigned long)(arg));
}
#else
...
#else
       gf66xx_parse_dts(gf66xx_dev);
       gf66xx_power_on(gf66xx_dev);
