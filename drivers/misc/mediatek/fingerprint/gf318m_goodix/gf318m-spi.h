...
//#define 		GF66XX_POWER_SOURCE_CUSTOM    NULL   //used as same to VGP1_PMU for TP
#define          GF66XX_PWR_PIN		GPIO_FIGERPRINT_PWR_EN_PIN
#define 		GF66XX_PWR_PIN_M_GPIO   GPIO_MODE_00

#define		GF66XX_IRQ_NUM		CUST_EINT_FIGERPRINT_INT_NUM//4      
#define 		GF66XX_INT_PIN 		GPIO_FIGERPRINT_INT /*GPIO3*/   //(GPIO4 | 0x80000000)

#define 		GF66XX_RST_PIN		GPIO_FIGERPRINT_RST   /*GPIO19*/   //(GPIO44 | 0x80000000)
#define 		GF66XX_SPI_RESET_PIN_M_GPIO   GPIO_MODE_00
#define 		GF66XX_SPI_RESET_PIN_M_DAIPCMOUT   GPIO_MODE_01

#define 		GF66XX_SPI_EINT_PIN_M_GPIO   GPIO_FIGERPRINT_INT_M_GPIO //GPIO_MODE_00
#define 		GF66XX_SPI_EINT_PIN_M_EINT   GPIO_FIGERPRINT_INT_M_EINT //GPIO_MODE_00

#define		GF66XX_SPI_SCK_PIN		GPIO_SPI_SCK_PIN
#define		GF66XX_SPI_SCK_PIN_M_GPIO	GPIO_MODE_00
#define		GF66XX_SPI_SCK_PIN_M_SCK	GPIO_SPI_SCK_PIN_M_SPI_CKA

#define		GF66XX_SPI_CS_PIN		GPIO_SPI_CS_PIN
#define		GF66XX_SPI_CS_PIN_M_GPIO	GPIO_MODE_00
#define		GF66XX_SPI_CS_PIN_M_CS	GPIO_SPI_CS_PIN_M_SPI_CSA
	
#define		GF66XX_SPI_MOSI_PIN		GPIO_SPI_MOSI_PIN 
#define		GF66XX_SPI_MOSI_PIN_M_GPIO	GPIO_MODE_00
#define		GF66XX_SPI_MOSI_PIN_M_MOSI	GPIO_SPI_MOSI_PIN_M_SPI_MOA

#define		GF66XX_SPI_MISO_PIN		GPIO_SPI_MISO_PIN
#define		GF66XX_SPI_MISO_PIN_M_GPIO	GPIO_MODE_00
#define		GF66XX_SPI_MISO_PIN_M_MISO	GPIO_SPI_MISO_PIN_M_SPI_MIA
