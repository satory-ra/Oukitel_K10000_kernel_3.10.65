...
/**********************************************************
  ...
  *
  *********************************************************/
#if defined(CONFIG_T925_PROJ)||defined(CONFIG_T89_PROJ)||defined(CONFIG_T87_PROJ)||defined(CONFIG_T875_PROJ)
	#define NCP1854_BUSNUM 1
#elif defined(CONFIG_T985_PROJ)||(CONFIG_T991_PROJ)||defined(CONFIG_T823_PROJ)
