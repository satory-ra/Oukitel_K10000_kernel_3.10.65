...
extern kal_uint8 ncp1854_sub_reg[NCP1854_REG_NUM];

//CON0
extern kal_uint32 ncp1854_sub_get_chip_status(void);

extern kal_uint32 ncp1854_sub_get_batfet(void);

extern kal_uint32 ncp1854_sub_get_statint(void);

extern kal_uint32 ncp1854_sub_get_faultint(void);


//CON1
extern void ncp1854_sub_set_reset(kal_uint32 val);

extern void ncp1854_sub_set_chg_en(kal_uint32 val);

extern void ncp1854v_set_otg_en(kal_uint32 val);

extern kal_uint32 ncp1854_sub_get_otg_en(void);

extern void ncp1854_sub_set_fctry_mode(kal_uint32 val);


extern void ncp1854_sub_set_tj_warn_opt(kal_uint32 val);

extern kal_uint32 ncp1854_sub_get_usb_cfg(void);

extern void ncp1854_sub_set_tchg_rst(kal_uint32 val);

extern void ncp1854_sub_set_int_mask(kal_uint32 val);

//CON2
extern void ncp1854_sub_set_wdto_dis(kal_uint32 val);

extern void ncp1854_sub_set_chgto_dis(kal_uint32 val);

extern void ncp1854_sub_set_pwr_path(kal_uint32 val);

extern void ncp1854_sub_set_trans_en(kal_uint32 val);

extern void ncp1854_sub_set_chg_halt(kal_uint32 val);

extern void ncp1854_sub_set_iinset_pin_en(kal_uint32 val);

extern void ncp1854_sub_set_iinlim_en(kal_uint32 val);

extern void ncp1854_sub_set_aicl_en(kal_uint32 val);

//CON8
extern kal_uint32 ncp1854_sub_get_vfet_ok(void);

//CON14
extern void ncp1854_sub_set_ctrl_vbat(kal_uint32 val);

//CON15
extern void ncp1854_sub_set_ieoc(kal_uint32 val);

extern void ncp1854_sub_set_ichg_high(kal_uint32 val);

extern void ncp1854_sub_set_ichg(kal_uint32 val);

extern kal_uint32  ncp1854_sub_get_ichg(void);

//CON16
extern void ncp1854_sub_set_iweak(kal_uint32 val);

extern void ncp1854_sub_set_ctrl_vfet(kal_uint32 val);

extern void ncp1854_sub_set_iinlim(kal_uint32 val);

//CON17
extern void ncp1854_sub_set_iinlim_ta(kal_uint32 val);

extern void ncp1854_sub_dump_register(void);

extern void ncp1854_sub_read_register(int i);

extern void kick_charger_wdt_sub(void);

extern kal_uint32 ncp1854_charging_get_current_sub(void);


extern kal_uint32 ncp1854_charging_hw_init_sub(void *data);

extern kal_uint32 ncp1854_charging_dump_register_sub(void *data);

extern kal_uint32 charging_set_input_current_sub(kal_uint32 data);


extern kal_uint32 ncp1854_charging_set_cv_voltage_sub(unsigned short reg_value);

extern kal_uint32 charging_set_current_sub(kal_uint32 current_val);
