...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.PS=LCM_PACKED_PS_24BIT_RGB888;
		params->dsi.vertical_sync_active				= 2;// 3    2      //4/10 modified by allen 
		params->dsi.vertical_backporch					= 18;// 20   1    //4/10 modified by allen 
		params->dsi.vertical_frontporch					= 20; // 1  12    //4/10 modified by allen 
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 10;// 50  2     //4/10 modified by allen 
		params->dsi.horizontal_backporch				= 150;//90        //4/10 modified by allen 
		params->dsi.horizontal_frontporch				= 80;//90         //4/10 modified by allen 
...
static unsigned int lcm_compare_id(void)
{
	...
	Lcd_Log("wqcat ili9881C_hongxian -%s, 0x00=0x%x,0x01=0x%x,id=0x%x\n", __func__, id_high, id_low,id);
#if defined(BUILD_LK)
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_ili9881c_dsi_vdo_hd_hsd = 
{
    .name           = "hct_ili9881c_dsi_vdo_hd_hsd",
