...
//-------------------- power on setting --------------------//
	...
	//-------------------- gamma --------------------//
	{0x00,	1,	{0x00}},
	{0xE1,	16,	{0x00,0x06,0x0b,0x0d,0x05,0x0e,0x0b,0x0a,0x03,0x07,0x0b,0x06,0x0e,0x13,0x0d,0x00}},
           
	{0x00,	1,	{0x00}},
	{0xE2,	16,	{0x00,0x06,0x0b,0x0d,0x05,0x0e,0x0b,0x0a,0x03,0x07,0x0b,0x06,0x0e,0x13,0x0d,0x00}}, 
...
#ifdef BUILD_LK
    printf("%s,  otm1283a+auo id = 0x%08x\n", __func__, id);
#else
    printk("%s,  otm1283a+auo id = 0x%08x\n", __func__, id);
#endif
