...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.vertical_backporch					= 12;//14;//50;
	params->dsi.vertical_frontporch					= 16;//50;
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active				= 10;//10
	params->dsi.horizontal_backporch				= 100;//34;//34; 
	params->dsi.horizontal_frontporch				= 100;//24;//24;
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_rm68200_dsi_vdo_hd_tm = 
{
	.name			= "hct_rm68200_dsi_vdo_hd_tm",
