...
static unsigned int lcm_compare_id(void)
{
	...
	id0  =  buffer[0];
        ...
        id = (id0 << 8) | id1;
#ifdef BUILD_LK
        printf("caozhengguang ili9881 %s, id0 = 0x%08x , id1 = 0x%08x, id = 0x%08x\n", __func__, id0, id1, id);
#else
        printk("caozhengguang ili9881 %s, id0 = 0x%08x , id1 = 0x%08x, id = 0x%08x\n", __func__, id0, id1, id);

#endif
        if (id == ILI9881_LCM_ID)
        {
           return 1;
        }
        else
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_ili9881_dsi_vdo_hd_idt = 
{
    .name           = "hct_ili9881_dsi_vdo_hd_idt",
