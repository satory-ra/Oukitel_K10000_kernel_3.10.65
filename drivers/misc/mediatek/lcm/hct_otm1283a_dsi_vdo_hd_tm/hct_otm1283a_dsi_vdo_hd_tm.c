...
static struct LCM_setting_table lcm_initialization_setting[] = {
    ...
    */
	...
	{0xFF,2,{0x12,0x83}},
	{0x00,1,{0x80}},             //source pre. 
	{0xC0,9,{0x00,0x64,0x00,0x0E,0x12,0x00,0x64,0x0E,0x12}},
	{0x00,1,{0xB4}},             //source pre. 
	{0xC0,1,{0x55}},
	{0x00,1,{0x80}},             //source pre. 
	{0xC4,1,{0x30}},
	{0x00,1,{0x8A}},             //source pre. 
	{0xC4,1,{0x40}},
	...
	{0xC4,1,{0x49}},
	{0x00,1,{0x82}},             //clock delay for data latch 
	{0xC4,1,{0x02}},
	{0x00,1,{0xC6}},             //clock delay for data latch 
	{0xB0,1,{0x03}},
	...
	{0xC5,2,{0x16,0x50}},
	{0x00,1,{0x00}},             //GVDD=4.5V, NGVDD=-4.5V
	{0xD8,2,{0x9d,0x9d}},	//7f	// B2 8E
	{0x00,1,{0x00}},             //VCOMDC
	{0xD9,1,{0x74}},//60
	...
	{0xC5,1,{0x66}},
	{0x00,1,{0xB2}},             //Frequency
	{0xF5,2,{0x00,0x00}},
	{0x00,1,{0xB4}},             //Frequency
	{0xF5,2,{0x00,0x00}},
	{0x00,1,{0xB6}},             //Frequency
	{0xF5,2,{0x00,0x00}},
	{0x00,1,{0xB8}},             //Frequency
	{0xF5,2,{0x00,0x00}},
	{0x00,1,{0x94}},             //Frequency
	{0xF5,1,{0x02}},
	{0x00,1,{0xBA}},             //Frequency
	{0xF5,1,{0x03}},
	{0x00,1,{0xB4}},             //Frequency
	{0xC5,1,{0xC0}},
	{0x00,1,{0x80}},          //Source level setting in Blanking frame  
	{0xC4,1,{0x00}},
	...
	{0xCB,11,{0xff,0xCf,0x00,0x03,0xC0,0xF0,0xFF,0x0C,0x30,0x00,0x0C}},
	{0x00,1,{0x80}},             //panel pad mapping control
	{0xCC,15,{0x06,0x2D,0x2E,0x0C,0x0A,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x00,1,{0x90}},             //panel pad mapping control
	{0xCC,15,{0x00,0x00,0x00,0x00,0x0E,0x02,0x04,0x05,0x2D,0x2E,0x0B,0x09,0x0F,0x00,0x00}},
	...
	{0xCC,15,{0x05,0x2E,0x2D,0x0D,0x0F,0x09,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x00,1,{0xc0}},             //panel pad mapping control
	{0xCC,15,{0x00,0x00,0x00,0x00,0x0B,0x03,0x01,0x06,0x2E,0x2D,0x0E,0x10,0x0A,0x00,0x00}},
	...
	{0x00,1,{0x90}},             
	{0xCE,14,{0x38,0x10,0x18,0x38,0x0F,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	...
	{0x00,1,{0x80}},             //panel CLKb3/4 setting
	{0xCF,14,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x00,1,{0x90}},             //panel CLKb3/4 setting
	{0xCF,14,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x00,1,{0xA0}},             //panel CLKb3/4 setting
	{0xCF,14,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x00,1,{0xB0}},             //panel CLKb3/4 setting
	{0xCF,14,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	...
	{0xC5,6,{0x38,0x00,0x3f,0x38,0x00,0x3f}},  //normal output with VGH/VGL
	
	{0x00,1,{0x00}},
	{0xE1,16,{0x00,0x10,0x17,0x0f,0x08,0x12,0x0c,0x0b,0x04,0x07,0x09,0x06,0x0e,0x0e,0x09,0x06}},
	{0x00,1,{0x00}},
	{0xE2,16,{0x00,0x10,0x17,0x0f,0x08,0x12,0x0c,0x0b,0x04,0x07,0x09,0x06,0x0e,0x0e,0x09,0x06}},


/*
{0x00,1,{0x00}},
	{0xE1,16,{0x01,0x02,0x03,0x07,0x00,0x00,0x02,0x00,0x2E,0x2D,0x18,0x08,0x0F,0x19,0x14,0x02}},
	{0x00,1,{0x00}},
	{0xE2,16,{0x01,0x02,0x03,0x07,0x00,0x00,0x02,0x00,0x2E,0x2D,0x18,0x08,0x0F,0x19,0x14,0x02}},
*/
	//{0x51,1,{ 0xff}},	// CABC
	//{0x53,1,{ 0x24}},
	//{0x55,1,{0x00}},	// Power Save Off
	//{REGFLAG_DELAY,20,{}},
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_otm1283a_dsi_vdo_hd_tm = 
{
    .name           = "hct_otm1283a_dsi_vdo_hd_tm",
