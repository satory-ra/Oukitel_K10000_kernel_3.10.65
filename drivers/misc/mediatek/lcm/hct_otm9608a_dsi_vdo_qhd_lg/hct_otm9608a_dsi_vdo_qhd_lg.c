...
#define LCM_PHYSICAL_ROTATION_180      1
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 16;//10
	params->dsi.vertical_frontporch					= 15;//10
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 
	params->dsi.horizontal_sync_active				= 8;//20
	params->dsi.horizontal_backporch				= 64;//44
...
#ifdef BUILD_LK
	printf("[erick-lk]%s,  otm9608a id = 0x%08x\n", __func__, id);
#else
	printk("[erick-k]%s,  otm9608a id = 0x%08x\n", __func__, id);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_otm9608a_dsi_vdo_qhd_lg = 
{
	.name			= "hct_otm9608a_dsi_vdo_qhd_lg",
