...
//	char buff[BMM050_BUFSIZE];				/* for chip information */
	char buff[sizeof(hwm_sensor_data)];				/* for chip information */
...
//			if(copy_to_user(argp, buff, strlen(buff)+1))
		...
		default:
			//( "%s not supported = 0x%04x", __FUNCTION__, cmd);
			return -ENOIOCTLCMD;
			break;		
		}
		...
		void* buff_out, int size_out, int* actualout)
{
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			break;
		default:
			//( "osensor operate function no this parameter %d!\n", command);
			err = -1;
			break;
	}
...
printk("[erick-bmm][%s][%d]:command = %d\n", __func__, __LINE__, command);
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			break;
		default:
			//( "m4g operate function no this parameter %d!\n", command);
			err = -1;
			break;
	}
...
printk("[erick-bmm][%s][%d]:command = %d\n", __func__, __LINE__, command);
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			break;
		default:
			//( "rotation vector operate function no this parameter %d!\n", command);
			err = -1;
			break;
	}
		...
		void* buff_out, int size_out, int* actualout)
{
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			break;
		default:
			//( "virtual linear accelerometer operate function no this parameter %d!\n", command);
			err = -1;
			break;
	}
		...
		void* buff_out, int size_out, int* actualout)
{
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			break;
		default:
			//( "virtual gravity operate function no this parameter %d!\n", command);
			err = -1;
			break;
	}
