...
#if defined (CONFIG_AW8736_MODE_CTRL)||defined(CONFIG_T93_PROJ)||defined(CONFIG_T935_PROJ)||defined(CONFIG_T825_PROJ)||defined(CONFIG_T89_PROJ)||defined(CONFIG_T925_PROJ)
...
#define AW8736_MODE3_SUB /*0.8w*/ \
    ...
    udelay(GAP); \
    mt_set_gpio_out(GPIO_EXT_SPKAMP2_EN_PIN,GPIO_OUT_ONE);
#define AW8736_MODE4_SUB /*it depends on THD, range: 1.5 ~ 2.0w*/ \
    mt_set_gpio_out(GPIO_EXT_SPKAMP2_EN_PIN,GPIO_OUT_ONE); \
    udelay(GAP); \
    mt_set_gpio_out(GPIO_EXT_SPKAMP2_EN_PIN,GPIO_OUT_ZERO); \
    udelay(GAP); \
...
{
#define SPK_WARM_UP_TIME        (55) //unit is ms hct chenxin modify
#ifndef CONFIG_FPGA_EARLY_PORTING
    int ret;
    ...
    #ifdef GPIO_EXT_SPKAMP_EN_PIN
    pin_extspkamp = GPIO_EXT_SPKAMP_EN_PIN;	//add by hct
    #endif
    if (enable)
    {
        ...
        #ifdef GPIO_EXT_SPKAMP2_EN_PIN
        pin_extspkamp_2 = GPIO_EXT_SPKAMP2_EN_PIN;	//add by hct
        #endif
		...
		AW8736_MODE1;
    #elif (defined(CONFIG_T985D_HD_PROJ)||defined(CONFIG_T93_PROJ)||defined(CONFIG_T935_PROJ)||defined(CONFIG_T87_PROJ)||defined(CONFIG_T823K_CQ_PROJ)||defined(CONFIG_T875_PROJ))&&!(defined(CONFIG_T93K_PROJ)||defined(CONFIG_T935K_PROJ))||defined(CONFIG_T825C_YX_PROJ)||defined(CONFIG_T825K_CQ_PROJ)
    		#if defined(CONFIG_T87A_OQ_PROJ)||defined(CONFIG_T87E_CQ_PROJ)
    		AW8736_MODE1;
    		#else
		AW8736_MODE2;
		#endif
...
static void Ext_Speaker_Amp_Change(bool enable)
{
#define SPK_WARM_UP_TIME        (55) //unit is ms hct chenxin moidfy
#ifndef CONFIG_FPGA_EARLY_PORTING
    ...
    #if defined(CONFIG_T925_PROJ)
		AW8736_MODE1;
    #elif (defined(CONFIG_T93_PROJ)||defined(CONFIG_T935_PROJ))&&!(defined(CONFIG_T93K_PROJ)||defined(CONFIG_T935K_PROJ))
	AW8736_MODE2;
    #else
        AW8736_MODE3;
    #endif
